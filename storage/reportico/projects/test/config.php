...
define('SW_DB_USER', 'newuser');
define('SW_DB_PASSWORD', '9X7HMMPvJCg');
define('SW_DB_HOST', 'psoftadmint1.cpyqvlnbuwrm.us-east-1.rds.amazonaws.com');
define('SW_DB_DATABASE', 'database2_mysqltest');
